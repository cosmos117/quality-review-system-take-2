...
class EmployeeProjectDetailPage extends StatefulWidget {
  ...
  const EmployeeProjectDetailPage({super.key, required this.project, this.description});

  @override
  State<EmployeeProjectDetailPage> createState() => _EmployeeProjectDetailsPageState();
}

class _EmployeeProjectDetailsPageState extends State<EmployeeProjectDetailPage> {
