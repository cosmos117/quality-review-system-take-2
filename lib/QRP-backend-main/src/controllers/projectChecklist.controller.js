 ...
 *
 * Formula: Sum of all iteration defect rates from completed iterations across all phases
 * Note: This is a simple summation and can exceed 100%
 *
 * Iteration Lifecycle:
 ...
 * - We sum: all past iterations (from array) across all phases
 */
const getOverallDefectRate = asyncHandler(async (req, res) => {
  ...
  for (const stage of stages) {
    ...
    if (checklist) {
      ...
      // Add ALL past iteration defect rates to the sum (including 0% rates)
  ...
  // FORMULA: Overall defect rate = Sum of all iteration defect rates from completed iterations
  // This is a simple sum and can exceed 100%
