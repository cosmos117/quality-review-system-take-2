...
import { compareAnswers, requestApproval, approve, revert, revertToExecutor, getApprovalStatus, getRevertCount, incrementRevertCount } from '../controllers/approval.controller.js';
...
router.post('/projects/:projectId/approval/revert-to-executor', revertToExecutor);
