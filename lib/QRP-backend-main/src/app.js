...
// Template routes must be registered BEFORE general /api/v1 routes
// because /api/v1 routes would otherwise intercept /api/v1/templates/* requests
...
// Checkpoint routes (integrated from V3)
