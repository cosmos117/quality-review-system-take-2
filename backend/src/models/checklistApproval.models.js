...
const checklistApprovalSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['pending', 'approved', 'reverted', 'reverted_to_executor'], default: 'pending' },
  ...
  executor_submitted: { type: Boolean, default: false },
  executor_submitted_at: { type: Date, default: null },
  reviewer_submitted: { type: Boolean, default: false },
  reviewer_submitted_at: { type: Date, default: null }
}, { timestamps: true });
