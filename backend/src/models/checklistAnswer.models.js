...
const checklistAnswerSchema = new mongoose.Schema(
  {
    ...
    /**
     * Metadata for special answer types (e.g., reviewer summary)
     * Stores arbitrary data that doesn't fit standard answer structure
     */
    metadata: {
    ...
    /**
     * Defect category ID (for reviewer role)
     * References the category from the template
     */
    categoryId: {
      type: String,
      default: "",
    ...
    /**
     * Defect severity (for reviewer role)
...
const ChecklistAnswer = mongoose.model(
  "ChecklistAnswer",
